...
<div class="bg-neutral-100 w-screen h-[200vh] grid place-items-center">
	<div
			...
			<div class="grid gap-[20px] test">
				{#each people as person, index}
					<div
						...
						style={`grid-area: ${GRID_AREAS[index]}; overflow: hidden !important; border-radius: 15px !important; position: relative !important;`}
					>
